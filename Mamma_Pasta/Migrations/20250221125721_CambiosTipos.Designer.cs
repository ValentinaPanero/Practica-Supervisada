...
namespace Mamma_Pasta.Migrations
{
    ...
    [Migration("20250221125721_CambiosTipos")]
    partial class CambiosTipos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mamma_Pasta.Models.RenglonVenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mamma_Pasta.Models.RenglonVenta", b =>
                {
                    b.HasOne("Mamma_Pasta.Models.Producto", "Productos")
                        .WithMany()
                        .HasForeignKey("ProductoId");

                    b.HasOne("Mamma_Pasta.Models.Venta", "Ventas")
                        .WithMany("RengVentas")
